...
public class CustomIOBigrams extends Configured implements Tool{
    ...
    public static void main(String[] args) throws Exception {
        int exitCode = ToolRunner.run(new CustomIOBigrams(), args);
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job();
        job.setJarByClass(CustomIOBigrams.class);
        job.setJobName("Preksha's output_CustomIO");
        ...
        CustomInputFormat.setInputPaths(job, new Path(args[0]));
    ...
    public static class MyMapper extends Mapper<Object, BytesWritable, Text, IntWritable> {
        ...
        public void map(Object key, BytesWritable value, Context context
            ...
            String word1 = new String( value.getBytes(), "UTF-8" );
            word1 = word1.toLowerCase();
            word1 = word1.replaceAll("[^a-z]+", " ");
            word1 = word1.replaceAll("^\\s+", "");
            StringTokenizer itr = new StringTokenizer(word1);
